...
public class accountsAccountIdDirectdebitsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/hsbc/RoostTest/accounts_AccountId_direct-debitsGetTest.csv", envVarsList);
    }
    ...
    public void accountsAccountIdDirectdebitsGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.hsbcnet.com/mock/obie/open-banking/v3.1/aisp";  
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.header("x-customer-user-agent", testData.get("x-customer-user-agent") != null ? testData.get("x-customer-user-agent") : "")
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("Data.DirectDebit["+ i +"].AccountId") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].AccountId"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].AccountId").length(), lessThanOrEqualTo(40));
  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].AccountId").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].DirectDebitId") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].DirectDebitId"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].DirectDebitId").length(), lessThanOrEqualTo(40));
  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].DirectDebitId").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].MandateIdentification") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].MandateIdentification"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].MandateIdentification").length(), lessThanOrEqualTo(35));
  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].MandateIdentification").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].DirectDebitStatusCode") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].DirectDebitStatusCode"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].DirectDebitStatusCode"), anyOf(equalTo("Active"), equalTo("Inactive")));
  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].Name") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].Name"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].Name").length(), lessThanOrEqualTo(70));
  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].Name").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].PreviousPaymentDateTime") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].PreviousPaymentDateTime"), instanceOf(String.class));  
          }
      
              if (response.get("Data.DirectDebit["+ i +"].Frequency") != null) {  
                MatcherAssert.assertThat(response.get("Data.DirectDebit["+ i +"].Frequency"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Data.DirectDebit["+ i +"].Frequency"), anyOf(equalTo("UK.OBIE.Annual"), equalTo("UK.OBIE.Daily"), equalTo("UK.OBIE.Fortnightly"), equalTo("UK.OBIE.HalfYearly"), equalTo("UK.OBIE.Monthly"), equalTo("UK.OBIE.NotKnown"), equalTo("UK.OBIE.Quarterly"), equalTo("UK.OBIE.Weekly")));
...
if(stringifiedStatusCode.equals("400")){					System.out.println("Description: Bad request");
              ...
              if (response.get("Errors["+ i +"].ErrorCode") != null) {  
                MatcherAssert.assertThat(response.get("Errors["+ i +"].ErrorCode"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Errors["+ i +"].ErrorCode"), anyOf(equalTo("UK.OBIE.Field.Expected"), equalTo("UK.OBIE.Field.Invalid"), equalTo("UK.OBIE.Field.InvalidDate"), equalTo("UK.OBIE.Field.Missing"), equalTo("UK.OBIE.Field.Unexpected"), equalTo("UK.OBIE.Header.Invalid"), equalTo("UK.OBIE.Header.Missing"), equalTo("UK.OBIE.Reauthenticate"), equalTo("UK.OBIE.Resource.ConsentMismatch"), equalTo("UK.OBIE.Resource.InvalidConsentStatus"), equalTo("UK.OBIE.Resource.InvalidFormat"), equalTo("UK.OBIE.Resource.NotFound"), equalTo("UK.OBIE.Rules.AfterCutOffDateTime"), equalTo("UK.OBIE.Rules.DuplicateReference"), equalTo("UK.OBIE.Signature.Invalid"), equalTo("UK.OBIE.Signature.InvalidClaim"), equalTo("UK.OBIE.Signature.Malformed"), equalTo("UK.OBIE.Signature.Missing"), equalTo("UK.OBIE.Signature.MissingClaim"), equalTo("UK.OBIE.Signature.Unexpected"), equalTo("UK.OBIE.UnexpectedError"), equalTo("UK.OBIE.Unsupported.AccountIdentifier"), equalTo("UK.OBIE.Unsupported.AccountSecondaryIdentifier"), equalTo("UK.OBIE.Unsupported.Currency"), equalTo("UK.OBIE.Unsupported.Frequency"), equalTo("UK.OBIE.Unsupported.LocalInstrument"), equalTo("UK.OBIE.Unsupported.Scheme")));
  
          }
      
              if (response.get("Errors["+ i +"].Message") != null) {  
                MatcherAssert.assertThat(response.get("Errors["+ i +"].Message"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Errors["+ i +"].Message").length(), lessThanOrEqualTo(500));
  
                MatcherAssert.assertThat(response.getString("Errors["+ i +"].Message").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("Errors["+ i +"].Path") != null) {  
                MatcherAssert.assertThat(response.get("Errors["+ i +"].Path"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("Errors["+ i +"].Path").length(), lessThanOrEqualTo(500));
  
                MatcherAssert.assertThat(response.getString("Errors["+ i +"].Path").length(), greaterThanOrEqualTo(1));
